...
$coloruno = trim($_POST['color1']);
$colordos = trim($_POST['color2']);
$colortres = trim($_POST['color3']);
$colorcuatro = trim($_POST['color4']);
$colorcinco = trim($_POST['color5']);
$colorseis = trim($_POST['color6']);
$colorsiete = trim($_POST['color7']);
$colorocho = trim($_POST['color8']);
$colornueve = trim($_POST['color9']);
$colordiez = trim($_POST['color10']);
...
{  
    ...
    {  
       ...
       //NOS CONECTAMOS A LA BASE DE DATOS 
        ...
        $query= " (categoria,nombre,articulo,material,talle,color1,color2,color3,color4,color5,color6,color7,color8,color9,color10,imagen) VALUES ('$categoria','$nombre','$codigo','$material','$talles','$color1','$color2','$color3','$color4','$color5','$color6','$color7','$color8','$color9','$color10','$nom_img')"; 
