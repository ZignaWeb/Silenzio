...
countries[0]['cities']=['Remeras','Cardigans','Camperitas','Poleras','Sweaters','Sacones'];
countries[1]=new Array();
countries[1]['country']='Tapados y Abrigos';
countries[1]['cities']=['Pilotos','Trench','Tapados','Chaquetas'];
countries[2]=new Array();
countries[2]['country']='Blazer';
countries[2]['cities']=['Clasicos','Diferenciados','Boyfriend'];
countries[3]=new Array();
countries[3]['country']='Pantalones';
countries[3]['cities']=['Recto','Bombilla','Palazo']; 
countries[4]=new Array();
countries[4]['country']='Jeans';
countries[4]['cities']=['Recto','Bombilla','Boyfriend']; 
countries[5]=new Array();
countries[5]['country']='Camisas y Blusas';
countries[5]['cities']=['Sin mangas','Manga Corta','Manga 3/4','Manga Larga']; 
countries[6]=new Array();
countries[6]['country']='Remeras';
countries[6]['cities']=['Musculosas','Sin Mangas','Manga corta','Manga 3/4','Manga larga','Saquitos']; 
countries[7]=new Array();
countries[7]['country']='Accesorios';
countries[7]['cities']=['Cinturones']; 
