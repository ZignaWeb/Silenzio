...
$ssql_b = "SELECT * FROM silenzio WHERE categoria='$_REQUEST[see]' ORDER BY id DESC"; 
...
.banner_derecho { width:760px; height:260px; border-bottom:10px solid #CCC; }
 ...
 .productos { width:760px; float:left; margin:0px; padding:0px; position:absolute; top:380px; }
...
<div id="izquierdo">
    ...
    { ?>
        ...
        <p class="seccion_tit"><? echo strip_tags($row->titulo) ?> / Todos </p>
  ...
  ?>
    ...
    { ?>
            	...
            	<li class="li_producto" onclick="parent.location='ampliada.php?amp=<? echo strip_tags($row_b->id) ?>'">
            		<?php $file="administrador/productos/".strip_tags($row_b->imagen_sil);
					if(file_exists($file)){ $img=$file;} else { $img="administrador/productos/FALTA.jpg";} ?>
                    <div style="width:233px;"><img src="<?php echo $img;?>" width="233" height="233" /></div>
